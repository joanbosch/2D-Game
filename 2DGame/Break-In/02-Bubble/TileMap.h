...
enum ENTITIES_TYPES {
	WOOD, ORANGE_BLOCK, GREEN_BLOCK, BLUE_BLOCK, SINGLE_COIN, COINS_BAG, MULTIPLE_COINS, DIAMOND, ALARM, AXE, STAR
};
...
public:
	...
	int getActualRoom() const { return actualRoom; };
...
private:
	...
	int tileSize, blockSize, actualRoom, actualLevel;
	Texture tilesheet;
